...
const int nlog2p0 = 16;              // p0 = 2 to the power of - nlog2p0 : standard value 8
const int nlog2pmut = 16;            // pmut = probmut = 2 to the power of - nlog2pmut
...
int selection = 0;                  // fitness model: 0 neutral, 1 selected gene prob of rule departure, 2 presence of replicase gene
int repscheme = 0;                  // replication scheme: 0 random choice , 1 XOR of all 3, 2 consensus, 3 unique det choice, 4 most different
